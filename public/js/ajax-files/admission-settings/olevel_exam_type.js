...
var OlevelExamType = function () {
    ...
    return {
        ...
        handleCalls: function () {
            ...
            $("#assignOlevelExamType").click(function (e) {
                OlevelExamType.assignOlevelExamType();
            });

            $("#removeOlevelExamType").click(function (e) {
                OlevelExamType.removeOlevelExamType();
            });

        },

        handleOlevelExamTypeData: function () {

            $(".list-olevelexamtype").dataTable().fnDestroy();
            var table = $('.list-olevelexamtype').DataTable({
//                    "processing": true,
//                    "serverSide": true,
                'ajax': {
                    'url': getBaseURL + "/admission/olevel-exam-type/all"
                },
                pageLength: 10,
                responsive: true,
                dom: '<"html5buttons"B>lTfgitp',
                buttons: [
                    {extend: 'excel', title: 'OlevelExamTypeList'},
                    {extend: 'pdf', title: 'OlevelExamTypeList'},
                    {extend: 'print',
                ...
                "aoColumns": [
                    {mData: "olevel_exam_type"},
                    {mData: "olevel_exam_type_description"},
            ...
            //---if edit ----- //
            $('.list-olevelexamtype tbody').on('click', '.btn-edit', function (e) {
                var $row = $(this).closest('tr');
                var data = table.row($row).data();
                var editurl = getBaseURL + "/admission/olevel-exam-type/" + data['id'] + "/edit";
        ...
        assignOlevelExamType: function () {
            ...
            $.ajax({
                url: getBaseURL + "/admission/olevel-exam-type/allot-group",
                ...
                success: function (data) {
                    OlevelExamType.loadOlevelExamType();
                    if (data.status === 1)
        ...
        // =========================================================================
        // Remove Olevel Exam Type
        // =========================================================================
        removeOlevelExamType: function () {
            ...
            $.ajax({
                url: getBaseURL + "/admission/olevel-exam-type/remove-group",
        ...
        // =========================================================================
        // Populate Olevel Exam Type
        // =========================================================================
        //------------ Load Olevel Exam Type ---------- //
        loadOlevelExamType: function () {
            FlicksApp.clear_diverror();
            var academic_course_option_standard_id = $("#academic_course_option_standard").val();
            $.ajax({
                url: getBaseURL + "/admission/olevel-exam-type/load-group",
