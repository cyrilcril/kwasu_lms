...
var Faculty = function () {
    ...
    return {
        ...
        handleCalls: function () {
            ...
            $("#assignAcademicFaculty").click(function (e) {
                Faculty.assignFaculty();
            });

            $("#removeAcademicFaculty").click(function (e) {
        ...
        handleFacultyData: function () {

            $(".list-faculty").dataTable().fnDestroy();
            var table = $('.list-faculty').DataTable({
//                    "processing": true,
//                    "serverSide": true,
                'ajax': {
                    'url': getBaseURL + "/employee/faculty/all"
                },
                pageLength: 10,
                responsive: true,
            ...
            //---if edit ----- //
            $('.list-faculty tbody').on('click', '.btn-edit', function (e) {
                var $row = $(this).closest('tr');
                var data = table.row($row).data();
                var editurl = getBaseURL + "/employee/faculty/" + data['id'] + "/edit";
        ...
        assignFaculty : function(){ 
            ...
            $.ajax({
                url: getBaseURL + "/employee/faculty/allot-group",
        ...
        removeFaculty : function(){
            ...
            $.ajax({
            url: getBaseURL + "/employee/faculty/remove-group",
        ...
        loadFaculty : function(){ 
            ...
            var academic_programme_id = $("#academic_programme").val();
            $.ajax({
                url: getBaseURL + "/employee/faculty/load-group",
