...
app.run(function ($rootScope, $http, defaultService, AppConstants) {
    ...
    $rootScope.initApplicantProgrammeCentre = function (val, obj_name) {
        if(val > 0)
            $rootScope.loadApplicantProgrammeCentre(val, obj_name);
    };

    $rootScope.loadApplicantProgrammeCentre = function (academic_programme_id, obj_name) {
    ...
    $rootScope.initAcademicCourseOption = function (session_standard_id, stream, academic_programme_id, academic_centre_id, academic_level_id, obj_name) {
        $rootScope.loadAcademicCourseOption(session_standard_id, stream, academic_programme_id, academic_centre_id, academic_level_id, obj_name);
    };
    ...
    $rootScope.loadAcademicCourseOption = function (session_standard_id, stream, academic_programme_id, academic_centre_id, academic_level_id, obj_name) {
        if (typeof obj_name != 'undefined')
            $rootScope.AcademicCourseOptions2 = [];
        else
            $rootScope.AcademicCourseOptions = [];
        urlPath = '/' + urlPrefix + 'load/course-option/fetch-by-level';
        params = {session_standard_id: session_standard_id, stream : stream, academic_programme_id: academic_programme_id, academic_programme_centre_id: academic_centre_id, academic_level_id: academic_level_id};
...
//               FlicksApp.handlemsgtoast(resp.msg,"error");
    ...
    $rootScope.initAcademicProgrammeBySession = function (val, stream, admission, academic, obj_name) {
        if(val > 0 /*&& stream > 0*/)
            $rootScope.loadAcademicProgrammeBySession(val, stream, admission, academic, obj_name);
    };

    $rootScope.loadAcademicProgrammeBySession = function (session_standard_id, stream, admission, academic, obj_name) {
        //$rootScope.AcademicProgrammeBySession = [];
        ...
        params = {academic_session_standard_id: session_standard_id, stream : stream_id, cur_admission: cur_admission, cur_academic : cur_academic};
    ...
    $rootScope.initAcademicSemesterBySessionStreamProgramme = function (session, stream, programme) {
        $rootScope.loadAcademicSemesterBySessionStreamProgramme(session, stream, programme);
    };

    $rootScope.loadAcademicSemesterBySessionStreamProgramme = function (session_standard_id, stream, programme_id) {
        $rootScope.AcademicSemesterBySessionStreamProgramme = [];
    ...
    $rootScope.initAcademicSemesterBySession = function (session, semester_id, current_admission, current_semester, student_id) {
        $rootScope.loadAcademicSemesterBySession(session, semester_id, current_admission, current_semester, student_id);
    };

    $rootScope.loadAcademicSemesterBySession = function (session_id, semester_id, current_admission, current_semester, student_id) {
        $rootScope.AcademicSemesterBySession = [];
        ...
        params = {academic_session_id: session_id, academic_semester_id : semester_id, current_admission : current_admission, current_semester: current_semester, student_id: student_id};
        $rootScope.academicsemesterloader = true;
        defaultService.allPostRequests(urlPath, params)
            .then(function (resp) {
                if (resp.length > 0) {
...
*/
     ...
     */
    $rootScope.initCourseOptionHeadStaff = function (academic_course_option_standard_id,academic_programme_id, active_status) {
        $rootScope.loadCourseOptionHeadStaff(academic_course_option_standard_id,academic_programme_id, active_status);
    };
    ...
    $rootScope.loadCourseOptionHeadStaff = function (academic_course_option_standard_id,academic_programme_id, active_status) {
        $rootScope.CourseOptionHeadStaffs = [];

        urlPath = '/' + urlPrefix + 'load/course-option/fetch-course-option-head-staff';
        params = {academic_course_option_standard_id: academic_course_option_standard_id,academic_programme_id: academic_programme_id, active_status : active_status};
    ...
    $rootScope.loadCourseOptionStandardByProgramme = function (academic_programme_id) {
        $rootScope.CourseOptionStandardByProgrammes = [];

        urlPath = '/' + urlPrefix + 'load/course-option/fetch-course-option-standard-by-programme';
        params = {academic_programme_id: academic_programme_id};
